...
const SocialMedia = () => {
  return (
    <div>
      <OutboundLink href="https://github.com/lowjiansheng">
        <img src={githubSvg} className="social-media" />
      </OutboundLink>
      <OutboundLink href="mailto:lowjiansheng@hotmail.sg">
        <img src={mailSvg} className="social-media" />
      </OutboundLink>
      <OutboundLink href="https://medium.com/@lowjiansheng">
        <img src={mediumSvg} className="social-media" />
      </OutboundLink>
      <OutboundLink href="https://twitter.com/lowjiansheng">
        <img src={twitterSvg} className="social-media" />
      </OutboundLink>
      <OutboundLink href="https://www.linkedin.com/in/jian-sheng-low-310b04131/">
